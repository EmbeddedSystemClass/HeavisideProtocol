...
#include "generic.h"
	...
	enum
	{
		...
		CHARACTERISTIC_PROTOCOL_STATE_ERROR
	};
	...
	typedef void (*CharacteristicProtocol_ErrorOccurredDelegate_t)(void);
#else
typedef void (*CharacteristicProtocol_PduReceivedDelegate_t)(CharacteristicProtocol_PduType_t pduType,
...
typedef void (*CharacteristicProtocol_ErrorOccurredDelegate_t)(void);
	...
	extern Bool_t CharacteristicProtocol_Start(uint8_t channelId);
	extern void CharacteristicProtocol_Execute(void);
	extern CharacteristicProtocol_State_t CharacteristicProtocol_GetState(void);
	extern void CharacteristicProtocol_Stop(void);
	extern void CharacteristicProtocol_ErrorHandler(void);
