...
/* Exported functions --------------------------------------------------------*/
void CharacteristicProtocol_Setup(uint8_t homeAddress,
...
void CharacteristicProtocol_Send(uint8_t destinationAddress, CharacteristicProtocol_PduType_t pduType,
...
#ifdef CHARACTERISTIC_PROTOCOL_SERVER_SIDE
	PduReceivedDelegate(source_address, pdu_type, char_id, unparsed_pdu_size);
#else
